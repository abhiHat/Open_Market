...
class _AddProductState extends State<AddProduct> {
  ...
  uploadProduct(File img) async{
    ...
    if(response.statusCode == 200){
        Toast.show("Product Added Successfully", context, duration: Toast.LENGTH_LONG, gravity: Toast.CENTER, backgroundColor: Colors.green[800], backgroundRadius: 12);
                 ...
                 Divider(),
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          border: InputBorder.none,
                          hintText: "Enter expected rent price for month"
                      ),
                    ),
                  ),
                  Container(
